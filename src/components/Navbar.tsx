      ...
      <div className="bg-[var(--color-primary)] text-white/90 text-[13px] py-1.5 sm:py-1 relative z-50 overflow-hidden">
        <div className="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8 flex flex-col sm:flex-row items-center justify-between gap-2 sm:gap-0 sm:h-8">
          ...
          <div className="flex items-center justify-center w-full sm:w-auto gap-3 shrink-0 bg-[var(--color-primary)] z-10 sm:pl-2">
            ...
            <a href="https://x.com/alimam_althahbi" target="_blank" rel="noopener noreferrer" className="hover:text-[var(--color-gold)] transition-colors" title="X (Twitter)">
            ...
            <a href="https://www.instagram.com/althahbi.bookshop" target="_blank" rel="noopener noreferrer" className="hover:text-[var(--color-gold)] transition-colors" title="Instagram">
            ...
            <a href="https://t.me/alimamalthahbi" target="_blank" rel="noopener noreferrer" className="hover:text-[var(--color-gold)] transition-colors" title="Telegram">
            ...
            <div className="px-4 py-6 space-y-4">
              ...
              <div className="pt-4 border-t" style={{ borderColor: "var(--color-border-light)" }}>
                ...
                <div className="flex items-center justify-center gap-6 pt-4">
                  <a href="https://x.com/alimam_althahbi" target="_blank" rel="noopener noreferrer" className="transition-colors" style={{ color: "var(--color-primary)" }}>
                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M18.901 1.153h3.68l-8.04 9.19L24 22.846h-7.406l-5.8-7.584-6.638 7.584H.474l8.6-9.83L0 1.154h7.594l5.243 6.932L18.901 1.153zM17.61 20.644h2.039L6.486 3.24H4.298l13.312 17.404z" /></svg>
                  </a>
                  <a href="https://www.instagram.com/althahbi.bookshop" target="_blank" rel="noopener noreferrer" className="transition-colors" style={{ color: "var(--color-primary)" }}>
                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zm0-2.163c-3.259 0-3.667.014-4.947.072-4.358.2-6.78 2.618-6.98 6.98-.059 1.281-.073 1.689-.073 4.948 0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98-1.281-.059-1.69-.073-4.949-.073zm0 5.838c-3.403 0-6.162 2.759-6.162 6.162s2.759 6.163 6.162 6.163 6.162-2.759 6.162-6.163c0-3.403-2.759-6.162-6.162-6.162zm0 10.162c-2.209 0-4-1.79-4-4 0-2.209 1.791-4 4-4s4 1.791 4 4c0 2.21-1.791 4-4 4zm6.406-11.845c-.796 0-1.441.645-1.441 1.44s.645 1.44 1.441 1.44c.795 0 1.439-.645 1.439-1.44s-.644-1.44-1.439-1.44z" /></svg>
                  </a>
                  <a href="https://t.me/alimamalthahbi" target="_blank" rel="noopener noreferrer" className="transition-colors" style={{ color: "var(--color-primary)" }}>
                  ...
                  <a href="https://www.tiktok.com/@alimamalthahbi7" target="_blank" rel="noopener noreferrer" className="transition-colors" style={{ color: "var(--color-primary)" }}>
