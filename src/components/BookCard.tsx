      ...
      <div className="flex-1 flex flex-col p-3">
        ...
        <div className="mt-auto">
          <a
            ...
            className="flex items-center justify-center gap-2 w-full py-2 rounded-full text-white text-sm font-medium transition-all hover:scale-[1.02] active:scale-[0.98]"
